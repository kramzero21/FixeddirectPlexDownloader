...
#Fixed Script to execute "Get-BitsTransfer | Complete-BitsTransfer" after download finished to complete the download and change the tmp file to correct name!
#
